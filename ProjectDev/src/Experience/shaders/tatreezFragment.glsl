...
void main()
{
  ...
  // vec3 originalColor = vec3(4.0/255.0, 10.0/255.0, 2.0/255.0);
  vec4 color = vec4(0.06 / length(centralUv)); //length( centralUV)= between 0- square of 2
  ...
  gl_FragColor = vec4(vec3(mixedColor * 1.25), 1.0);
